...
//   // This function handles the add to cart and opens the sidebar
//   const addToCartHandler = (cartItem: CartItem) => {
//     if (cartItem.stock < 1) return toast.error("Out of Stock");
//     dispatch(addToCart(cartItem));
//     toast.success("Added to cart");
//     setIsCartOpen(true); // Open the sidebar when an item is added to the cart
//   };
...
//                   ))}
//                 </div>
//                 {/* Pass isCartOpen prop to CartSidebar */}
//                 <CartSidebar
//                   isCartOpen={isCartOpen}
//                   setIsCartOpen={setIsCartOpen}
//                 />
...
function ProductListing() {
  ...
  const [isCartOpen, setIsCartOpen] = useState(false); // Track sidebar open/close state
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        ...
        setIsCartOpen(false); // Close the sidebar if clicked outside
      }
    };
          ...
          {productLoading ? (
            ...
            <div className="bg-white">
              <div className="mx-auto max-w-2xl py-2 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
                ...
                <CartSidebar
                  ref={sidebarRef} // Attach the ref to the CartSidebar component
                  isCartOpen={isCartOpen}
                  setIsCartOpen={setIsCartOpen}
                />
              </div>
